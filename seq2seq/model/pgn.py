...
from seq2seq.coder_pgn.rnn_encoder import Encoder
from seq2seq.coder_pgn.rnn_decoder import Decoder, BahdanauAttentionCoverage, Pointer
...
class PGN(tf.keras.Model):
    ...
    def call_decoder_one_step(self, dec_input, dec_hidden, enc_output,
                              enc_extended_inp, batch_oov_len, enc_pad_mask,
                              use_coverage, prev_coverage):
        context_vector, attentions, coverage_ret = self.attention(
